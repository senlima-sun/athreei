...
export const upsertPermission = permissionsRepository.upsert.bind(
  permissionsRepository
)
export const deletePermission = permissionsRepository.delete.bind(
  permissionsRepository
)
export const listPermissions = permissionsRepository.list.bind(
  permissionsRepository
)
export const countPermissions = permissionsRepository.count.bind(
  permissionsRepository
)
export const deletePermissionsByOrigin =
  permissionsRepository.deleteByOrigin.bind(permissionsRepository)
