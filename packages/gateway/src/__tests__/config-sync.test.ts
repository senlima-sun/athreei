...
import { loadConfig, saveConfigTemplate, ConfigSyncManager } from "../config-sync";
...
describe("loadConfig", () => {
  ...
  it("throws for missing apiKey", () => {
    ...
    expect(() => loadConfig(configPath)).toThrow("missing required field: apiKey");
  });
  ...
  it("throws for missing endpoint", () => {
    ...
    expect(() => loadConfig(configPath)).toThrow("missing required field: endpoint");
  });
  ...
  it("throws for empty apiKey", () => {
    ...
    writeFileSync(
      configPath,
      JSON.stringify({ apiKey: "", endpoint: "test" })
    );
...
describe("ConfigSyncManager", () => {
  ...
  describe("with mocked fetch", () => {
    ...
    it("handles auth errors", async () => {
      ...
      await expect(manager.initialSync()).rejects.toThrow("Authentication failed");
    });
