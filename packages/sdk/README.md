...
enableMockMode({
  ...
  mockResponses: {
    search_products: {
      results: [{ id: "1", name: "Test Product", price: 99.99 }],
    },
  },
  autoTriggerTools: [
    {
...
athreei.registerTool({
  name: "search_products",
  description:
    "Search the product catalog by keyword, category, or filters. Returns up to 50 matching products with pricing and availability.",
  parameters: {
    query: {
      type: "string",
      required: true,
