...
describe("MCP Registry Seed Data", () => {
  ...
  describe("validateSeedData", () => {
    ...
    it("should detect invalid transport type", () => {
      ...
      expect(result.errors.some((e) => e.includes("invalid transport"))).toBe(
        true
      )
    })
